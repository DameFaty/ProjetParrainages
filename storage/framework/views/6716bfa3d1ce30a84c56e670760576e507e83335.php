...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container mt-4">
            ...
            <div class="container">
                <div class="text-right">
                    <a href="candidat/create" class="btn btn-dark mt-2"> Ajouter Candidat</a>
                </div>
            </div>
            <?php endif; ?>
             <table class="table table-bordered mt-4">
               ...
               <tbody>
                   <?php $__currentLoopData = $listCan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($tot->id); ?></td>
                        <td><?php echo e($tot->nom); ?></td>
                        <td><?php echo e($tot->prenom); ?></td>
                        <td><?php echo e($tot->parti); ?></td>
                        <td><?php echo e($tot->programme); ?></td>
                        <td><?php echo e($tot->valide); ?></td>
                        <td>
                            <img src="/Candidats/<?php echo e($tot->photo); ?>" class="rounded-circle" width="50" height="50"  />
                        </td>
       ...
       <?php /**PATH C:\Users\damef\projetPairrainages\resources\views/candidat/list_candidats.blade.php ENDPATH**/ ?>